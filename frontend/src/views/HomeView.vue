  ...
  <div class="container">
    <div >
        <div v-if="token === null" class="centers">
            <h1>Welcome to the Research Institute of Museum Sciences</h1>
            <p>Here you can found your own research museum and catalog your scientific exhibits in it</p>
            <p></p>
        </div>
