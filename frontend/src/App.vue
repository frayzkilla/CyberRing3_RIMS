    ...
    <template #left>
      <router-link to="/" class="link">
        <va-navbar-item class="logo">
            Research Institute of Museum Sciences
        </va-navbar-item>
      </router-link>
    </template>
...
<!--      <va-navbar-item><router-link v-if="token !== null" to="/books" class="link">My books</router-link></va-navbar-item>-->
      <va-navbar-item><router-link  to="/museums" class="link">Explore Institute Museums</router-link></va-navbar-item>
        <va-navbar-item><router-link  v-if="token !== null" to="/exhibit/create" class="link">Add Exhibit</router-link></va-navbar-item>
